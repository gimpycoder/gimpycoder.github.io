// http://www.zekechan.net/asteroids-html5-game-tutorial-5/
...
var gameProperties = {
    ...
    delayToStartLevel: 3,
    padding: 30, // actual world margin which allows for better asteroid warp.
};
...
var shipProperties = {
    ...
    acceleration: 300,      // how fast ship increases velocity
    drag: 100,              // friction that slows down ship
    maxVelocity: 300,       // maximum movement velocity
    angularVelocity: 200,   // how fast ship can rotate
    startingLives: 3,
    timeToReset: 3,         // allowed "invulnerability" time
    blinkDelay: 0.2,        // time between shown and hidden ship during invulnerability (blinking)
};

var bulletProperties = {
    speed: 400,             // velocity of bullet
    interval: 250,          // firing rate
    lifespan: 2000,         // life of bullet in game world
    maxCount: 30,           // max number of shown bullets
};
...
var gameState = function(game){
    ...
    this.tf_lives;      // lives counter display
    
    
    this.tf_score;      // score display
    
    this.sndDestroyed;  // destroyed sound
    this.sndFire;       // fire sound
...
gameState.prototype = {
    ...
    preload: function () {
        ...
        game.load.spritesheet(graphicAssets.explosionMedium.name, graphicAssets.explosionMedium.URL,
                              graphicAssets.explosionMedium.width, graphicAssets.explosionMedium.height,
                              graphicAssets.explosionMedium.frames);
                              
        game.load.spritesheet(graphicAssets.explosionSmall.name, graphicAssets.explosionSmall.URL,
                              graphicAssets.explosionSmall.width, graphicAssets.explosionSmall.height,
                              graphicAssets.explosionSmall.frames);
    },
    ...
    initGraphics: function() {
        ...
        this.shipSprite.anchor.set(0.5, 0.5); // defines point of rotation.
    ...
    initKeyboard: function() {
                                    // found in Phaser Keyboard.js file:
